...
export interface DraggableRowProps<TableData> extends DraggableAndExpandableRow<TableData> {
    ...
    return (
        <Fragment key={row.id}>
            ...
            >
                ...
                <TableUnvirtualized.Body.Cell key={firstCell.id} ref={virtualMeasureRef}>
