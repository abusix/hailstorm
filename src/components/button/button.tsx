...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
    ({ className, children, onClick, loading, LeftIcon, RightIcon, disabled = false, type = 'primary' }, ref) => {
        return (
            <button
                type="button"
            ...
            >
                ...
                {LeftIcon && !loading ? <LeftIcon className={`${iconVariants[type]} h-3 w-3`} /> : null}
