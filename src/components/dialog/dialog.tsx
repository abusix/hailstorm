            ...
            <HeadlessDialog as="div" onClose={handleClose}>
                ...
                >
                    ...
                    >
                        <HeadlessDialogPanel
                            className={classNames(
                                "bg-bg-primary text-text-primary flex w-184 transform flex-col overflow-y-auto rounded-md shadow-lg transition-all",
                                !footer && "pb-8",
                                className
                            )}
                        >
                            <div className="relative mx-10 mt-10">
                                <HeadlessDialogTitle className="mb-6 pr-12 text-lg font-semibold">
                                    {title}
                                </HeadlessDialogTitle>
                            ...
                            {!!footer && (
                                <div
                                    id="dialog-footer"
                                    className={classNames(
                                        "bg-bg-primary sticky bottom-0 left-0 flex flex-row gap-2 px-10 pt-8 pb-8",
