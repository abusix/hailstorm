...
const SvgLayoutSkewGridIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <circle cx={10} cy={14} r={2} fillRule='evenodd' clipRule='evenodd' />
    <circle cx={10} cy={6} r={2} fillRule='evenodd' clipRule='evenodd' />
  </svg>
)
export default SvgLayoutSkewGridIcon
