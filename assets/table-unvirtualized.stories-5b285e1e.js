import{j as e}from"./jsx-runtime-94f6e698.js";import{r as o}from"./index-8db94870.js";import{T as a}from"./table-unvirtualized-a2f985a5.js";import{B as h}from"./button-e052d89c.js";import"./_commonjsHelpers-042e6b4d.js";import"./class-names-9cb99c69.js";import"./spinner-59a2feb3.js";const g={title:"Table / Unvirtualized",component:a};function U(){const r=[];for(let l=0;l<20;l++){const n={id:l.toString(),name:`${l.toString()} name`,description:`${l.toString()} description`,price:l};r.push(n)}return r}const i=()=>{const r=o.useMemo(()=>U(),[]);return e.jsxs(a,{children:[e.jsx(a.Header,{children:e.jsxs(a.Header.Row,{children:[e.jsx(a.Header.Cell,{className:"w-40",children:"Name"}),e.jsx(a.Header.Cell,{children:"Description"}),e.jsx(a.Header.Cell,{align:"right",children:"Price"})]})}),e.jsx(a.Body,{children:r.map(l=>e.jsxs(a.Body.Row,{children:[e.jsx(a.Body.Cell,{children:l.name}),e.jsx(a.Body.Cell,{children:l.description}),e.jsx(a.Body.Cell,{align:"right",children:e.jsxs("span",{className:"whitespace-nowrap font-mono",children:["$ ",l.price.toFixed(2)]})})]},l.id))})]})},t=()=>e.jsxs(a,{children:[e.jsx(a.Header,{children:e.jsxs(a.Header.Row,{children:[e.jsx(a.Header.Cell,{className:"w-40",children:"Name"}),e.jsx(a.Header.Cell,{children:"Description"}),e.jsx(a.Header.Cell,{align:"right",children:"Price"})]})}),e.jsx(a.Body,{children:e.jsx(a.Body.EmptyPlaceholder,{title:"Empty table",description:"You have not added any items yet.",colSpan:3,children:e.jsx(h,{type:"secondary",onClick:()=>alert("clicked"),children:"Add New Item"})})})]}),d=()=>{const[r,l]=o.useState([]);return o.useEffect(()=>{const n=setTimeout(()=>{l(U())},4e3);return()=>{clearTimeout(n)}},[]),e.jsxs(a,{children:[e.jsx(a.Header,{children:e.jsxs(a.Header.Row,{children:[e.jsx(a.Header.Cell,{className:"w-40",children:"Name"}),e.jsx(a.Header.Cell,{children:"Description"}),e.jsx(a.Header.Cell,{align:"right",children:"Price"})]})}),e.jsx(a.Body,{children:r.length?r.map(n=>e.jsxs(a.Body.Row,{children:[e.jsx(a.Body.Cell,{children:n.name}),e.jsx(a.Body.Cell,{children:n.description}),e.jsx(a.Body.Cell,{align:"right",children:e.jsxs("span",{className:"whitespace-nowrap font-mono",children:["$ ",n.price.toFixed(2)]})})]},n.name)):e.jsx(a.Body.LoadingIndicator,{colSpan:3})})]})};var s,c,u;i.parameters={...i.parameters,docs:{...(s=i.parameters)==null?void 0:s.docs,source:{originalSource:`() => {
...
//# sourceMappingURL=table-unvirtualized.stories-5b285e1e.js.map
